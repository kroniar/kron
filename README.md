...
You can install Kron globally so you can run it from anywhere in your terminal.
...
After installation, restart your terminal (or run `source ~/.bashrc`) and verify:

```bash
kron
```

You should see the CLI help menu — you can now use `kron` from any directory.
...
Then restart PowerShell or Command Prompt and run:

```powershell
kron
```

✅ Done! Kron is now globally available in your PATH.
